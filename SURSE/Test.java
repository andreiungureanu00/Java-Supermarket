...
public class Test {
    public static void main(String args[]) throws FileNotFoundException{
        ...
        File st = new File("D:/LABORATOARE POO/TEMA_POO/Tema/test/store.txt");
        File cust = new File("D:/LABORATOARE POO/TEMA_POO/Tema/test/customers.txt");
        File ev = new File("D:/LABORATOARE POO/TEMA_POO/Tema/test/events.txt");
